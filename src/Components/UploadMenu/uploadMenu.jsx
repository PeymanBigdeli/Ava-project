    ...
    return(
        <div className="upload-box-container">
            <ul className="upload-method-list">
                <UploadMethodItem text="ضبط صدا" svgPath={`/images/mic-icon${uploadMethod !== "record" ? "-inactive" : ""}.svg`} 
                            isActive={uploadMethod === "record"} 
                            clickHandler={() => setUploadMethod("record")} 
                            currMethod={uploadMethod}
                            />
                <UploadMethodItem text="بارگذاری فایل" svgPath={`/images/upload-icon${uploadMethod !== "file" ? "-inactive" : ""}.svg`}
                            isActive={uploadMethod === "file"} 
                            clickHandler={() => setUploadMethod("file")} 
                            currMethod={uploadMethod}
                            />
                <UploadMethodItem text="لینک" svgPath={`/images/chain-icon${uploadMethod !== "link" ? "-inactive" : ""}.svg`} 
